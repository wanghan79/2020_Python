...
"""
    ...
    Purpose: 
        Part of the second python class homework in spring semester, 2020
    
    Introduction:
        Test functions for Random_gener_picker_doc
        
    Special Tips:
        Please put this and Random_gener_picker_doc.py in the same dictionary
...
from Random_gener_picker_dec import Random_gener_picker
import string
import sys

...
def check():
    ...
    while True:
        try:
           ...
           # 整型随机数生成
    print("Integer random number generation:",end="")
    for x in myint.find({},{ "value": 1, "_id": 0 }):
        for m,n in x.items():
            result1.append(n)
    print(result1)
    results1s = dataScreening(result1, 10, 100)
    print("Filtered integer random number:",results1s)
    ...
    while True:
        try:
            ...
            # 浮点随机数生成
    print("Floating point random number generation:",end="")
    for x in mydouble.find({},{ "value": 1, "_id": 0 }):
        for m,n in x.items():
            result2.append(n)
    print(result2)
    results2s = dataScreening(result2, 10.0, 100.0)
    print("Filtered floating-point random number:",results2s)
    ...
    while True:
        try:
            ...
            #字符随机数生成
    print("Character random number generation:",end="")
    ...
    print("Random number of characters after filtering:", results3s)
